...
Step 5 Save
Use write_file and save one JSON file named transportation.json
...
Return only the JSON, named transportation.json in ./research/
Also, you need to write an analyze of these data and give a scoreboard, named transportation_scoreboard.md
"""
