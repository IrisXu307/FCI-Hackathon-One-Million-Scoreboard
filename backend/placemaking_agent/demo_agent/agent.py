...
Step 5 Save
Use write_file and save one JSON file named placemaking.json
...
Return only the JSON, named placemaking.json in ./research/
Also, you need to write an analyze of these data and give a scoreboard, named placemaking_scoreboard.md
"""
