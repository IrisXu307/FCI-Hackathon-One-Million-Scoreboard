...
Step 5 Save
Use write_file and save one JSON file named healthcare.json
...
Return only the JSON, named healthcare.json in ./research/
Also, you need to write an analyze of these data and give a scoreboard, named healthcare_scoreboard.md
"""
