...
graph = create_deep_agent(
    ...
    subagents=[
        {
            "name": "federal-researcher",
            "description": "Fetches federal data from Statistics Canada, CMHC, and Infrastructure Canada",
            "system_prompt": "You specialize in federal data. Search and save findings to /research/ with appropriate name. ",
            "tools": [internet_search],
        },
        {
            "name": "provincial-researcher",
            "description": "Fetches provincial data from Ontario ministries",
            "system_prompt": "You specialize in provincial data. Search and save findings to /research/ with appropriate name. ",
            "tools": [internet_search],
        },
        {
            "name": "regional-municipal-researcher",
            "description": "Fetches Regional and Municipal data for Waterloo Region and its municipalities",
            "system_prompt": "You specialize in waterloo data. Search and save findings to /research/ with appropriate name. ",
            "tools": [internet_search],
        },
        {
            "name": "other-researcher",
            "description": "Fetches other data from university research, real estate boards, and realtor platforms",
            "system_prompt": "You specialize in other data. Search and save findings to /research/ with appropriate name. ",
            "tools": [internet_search],
        },
    ],
)
