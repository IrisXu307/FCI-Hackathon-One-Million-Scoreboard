...
Step 5 Save
Use write_file and save one JSON file named employment.json
...
Return only the JSON, named employment.json in ./research/
Also, you need to write an analyze of these data and give a scoreboard, named employment_scoreboard.md
"""
